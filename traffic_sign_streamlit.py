...
# Load trained model
model = load_model(r"C:\Users\HP\VS CODE\Traffic Sign Recognition\traffic_sign.h5")

# Dictionary for traffic signs
classes = {
...
st.markdown("Upload a traffic sign image and the model will predict the class.")
...
if uploaded_file is not None:
    ...
    if st.button("Classify Traffic Sign"):
        with st.spinner("Classifying... ⏳"):
            ...
            st.success(f"✅ The image you uploaded is predicted as: **{sign}**")
