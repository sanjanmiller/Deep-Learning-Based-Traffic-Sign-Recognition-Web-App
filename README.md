...
```bash
git clone [https://github.com/sanjanmiller/Deep-Learning-Based-Traffic-Sign-Recognition-Web-App.git](https://github.com/sanjanmiller/Deep-Learning-Based-Traffic-Sign-Recognition-Web-App.git)
